...
<head>
  ...
  <style>
    ...
    .error{background:#fee;color:#900;border:1px solid #f99}
    .ok{background:#eef9f0;color:#064;border:1px solid #9ecf9e}
...
<body>
  ...
  <?php
  // Flash message from process_traveller.php
  ...
  <?php
    ...
    if (!$rows) {
      ...
      echo "<table><thead><tr>
            ...
            <th>DOB</th><th>Country</th></tr></thead><tbody>";
      foreach ($rows as $r) {
        echo "<tr>
  ...
  ?>
  <p><small>Demo idea: try a failed insert first, then a valid one.</small></p>
</body>
</html>
